package problem.p2xxx.p20xx.p2115m;
...
public class PossibleRecipes {
    ...
    public static void main(String[] args) {
        ...
        List<String> ingredient1 = Arrays.asList("yeast","flour");
        List<String> ingredient2 = Arrays.asList("bread","meat");
        List<String> ingredient3 = Arrays.asList("sandwich","meat","bread");
        List<List<String>> ingredients = Arrays.asList(ingredient1, ingredient2, ingredient3);
        String[] supplies = {"yeast","flour","meat"};
        UtilityClass.logResult(findAllRecipes(recipes, ingredients, supplies));
    }
}
